package es.outlook.adriansrj.neptunetrial.util.file;
 ...
 * <p>
 * Instances of this abstract class may be passed to the <code>{@link File#listFiles(FileFilter)
 * listFiles(FileFilter)}</code> method of the <code>{@link File}</code> class.
 * <p>
 *
 * @author AdrianSR
 */
